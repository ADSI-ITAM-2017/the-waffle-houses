class PropertiesController < ApplicationController
  ...
  private
    ...
    def property_params
      params.require(:property).permit(:title, :cost, :delegacion, :colonia, :street, :interior, :exterior, :zipcode, :tipo, :roomie, :room, :pet, :parking, :service, :internet, :description)
    end
end
